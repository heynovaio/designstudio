...
export const Hero = ({ title, description, catalogLabel, worksLabel, gallery, bottom }) => {
	const responsive = {
		mobile: {
	...
	const ButtonGroup = ({ next, previous }) => {
		return (
			<div className={sty.carouselButtonGroup}>
				<div className={sty.next} onClick={() => { 
						next();
						handleSlide(); 
					}}>
					<IoIosArrowForward />
			...
			<Container>
				<div className={sty.flexWrap}>
					<div className={sty.copy}>
						{title && <PrismicRichText field={title.richText} className={sty.title}/>}
